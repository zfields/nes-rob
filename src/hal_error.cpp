...
hal_category_impl::default_error_condition (
    ...
    switch (static_cast<nes::rob::hal_error>(ev)) {
      default:
...
hal_category_impl::message (
    ...
    switch (static_cast<nes::rob::hal_error>(ev)) {
      case nes::rob::hal_error::success:
        return "Success.";
      case nes::rob::hal_error::peripheral_gpio:
        return "GPIO peripheral failure.";
      case nes::rob::hal_error::sys_clock:
        return "System clock failure.";
      case nes::rob::hal_error::sys_config:
...
const std::error_category &hal_category()
{
    static hal_category_impl instance;
    return instance;
}

std::error_code nes::rob::make_error_code(nes::rob::hal_error e)
{
    return {static_cast<int>(e), hal_category()};
}

std::error_condition nes::rob::make_error_condition(nes::rob::hal_error e)
{
    return {static_cast<int>(e), hal_category()};
}
